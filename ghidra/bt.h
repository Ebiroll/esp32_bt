...
//typedef struct {
// (bt_util_buf_env + 0x14) free_list;
// 
//  (bt_util_buf_env + ((bufIx - 0x274c) / 0x404 & 0xff) * 0xc + 0xac)
// acl_tx_alloc
// piVar1 = r_co_list_pop_front((int **)(bt_util_buf_env + 0x28));
// 
// int ** r_bt_util_buf_sync_tx_alloc(uint param_1,byte param_2)
// ppiVar1 = *(int ***)(bt_util_buf_env + (param_1 & 0xff) * 4 + 0x160);
// 
// r_HMAC returns 0x3ffb80c0 GenericHashOutput[32];
// undefined4 r_em_buf_init(void)  iVar1 = 0x3ffb9274;
// 

/* BT util funcs */
typedef struct {
  void (*_r_bt_util_buf_init)(void):
  int* (*_r_bt_util_buf_lmp_tx_alloc)(void);
  unsigned int (*_r_bt_util_buf_lmp_tx_free)(unsigned int *buff);
  int* (*_r_bt_util_buf_acl_rx_alloc)(void);
  unsigned int (*r_bt_util_buf_acl_rx_free)(unsigned int bufix);
  int* (*_r_bt_util_buf_acl_tx_alloc)(void);
  unsigned int (*_r_bt_util_buf_acl_tx_free)(unsigned int buffix);
  unsigned int* (*_r_bt_util_buf_sync_init)(uint param_1,uint param_2,uint param_3,uint param_4,uint param_5);
  int * (*_r_bt_util_buf_sync_clear)(uint param_1);
  int ** (*_r_bt_util_buf_sync_tx_alloc)(unsigned char ix,unsigned char param_2);
  unsigned int (*_r_bt_util_buf_sync_tx_free)(uint param_1,uint param_2);
  int* (*_r_bt_util_buf_sync_rx_alloc)(uint param_1,byte param_2);
  unsigned int * (*_r_bt_util_buf_sync_rx_free)(uint param_1,uint param_2);
  unsigned char * (*_r_E1)(unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4,
           unsigned int param_5,unsigned int param_6);
  unsigned int * (*_r_E21)(unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4,unsigned int param_5
     ,unsigned int param_6,unsigned char *param_7);
  unsigned int * (*_r_E22)(unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4,unsigned int param_5
     ,unsigned int param_6);
  unsigned int (*_r_KPrimC)(unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4,unsigned int param_5,unsigned int *param_6);
  unsigned int (*r_XorKey)(unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4);
  int (*_r_LM_MakeRandVec)(int param_1);
  unsigned int (*_r_lmp_pack)(unsigned int *param_1,char *param_2);
  unsigned int (*r_lmp_unpack)(unsigned int *param_1,unsigned char *param_2,unsigned char *param_3);
  unsigned int  (*_r_lm_n_is_zero)(unsigned int param_1);  
  unsigned int* (*_r_lm_sp_n_one)(void *param_1,int param_2);
  unsigned char* (*_r_lm_sp_sha256_calculate)(unsigned char *param_1,unsigned int *param_2,unsigned short param_3);
  unsigned int (*r_lm_sp_n192_convert_wnaf)(int param_1,int param_2,uint *param_3);
  unsigned int r_lm_sp_p192_point_to_inf(int param_1);
  undefined4 r_lm_sp_p192_point_jacobian_to_affine(int *param_1);
  undefined4 r_lm_sp_p192_points_jacobian_to_affine(int param_1);
  undefined4 r_lm_sp_pre_compute_points(uint *param_1);
  ...
  uint * r_lm_f1(int param_1,undefined *param_2,uint param_3,uint param_4,int param_5);
  uint *r_lm_f2(void *param_1,void *param_2,void *param_3,void *param_4,int param_5,undefined *param_6);
  uint r_lm_g(void *param_1,void *param_2,char param_3,int param_4,uint *param_5); 
  uint *r_lm_f3(void *param_1,void *param_2,void *param_3,undefined4 param_4,void *param_5,void *param_6,
       int param_7,undefined *param_8);
  void * r_lm_get_nonce(void *param_1);
  unsigned int r_lm_dhkey_calc_init(int param_1); 
  void r_lm_dhkey_compare(int param_1)  
  undefined * r_F1_256(int param_1,int param_2,int param_3,undefined *param_4,int param_5);
  uint  * r_HMAC(int param_1,int param_2,int param_3,uint param_4);
  int r_G_256(int param_1,int param_2,int param_3,int param_4,uint *param_5); 
  uint  r_SHA_256(int param_1,uint param_2,undefined *param_3);
  unsigned int *r_F2_256(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7); 
  unsigned int *r_F3_256(int param_1,int param_2,int param_3,int param_4,undefined *param_5,int param_6,int param_7,
        int param_8);
 int r_H3(int param_1,int param_2,int param_3,int param_4,int param_5);
 int r_H4(int param_1,int param_2,int param_3,int param_4);
 int r_H5(int param_1,int param_2,int param_3,int param_4);
 int r_hashConcat(int param_1,uint param_2,int param_3,uint param_4,int param_5);
 unsigned int* r_ea_elt_cancel(int **param_1);
 uint r_ea_time_get_slot_rounded(void);
 uint r_ea_init(void);
 ushort * r_ea_elt_create(uint param_1);
 undefined4 r_ea_elt_insert(undefined4 *param_1);
 uint r_ea_time_get_halfslot_rounded(void);
 undefined4 r_ea_elt_remove(int *param_1);
 ushort * r_ea_interval_create(void);
 undefined4 * r_ea_interval_insert(undefined4 *param_1);
 int * r_ea_interval_remove(int *param_1);
 int * r_ea_interval_delete(int *param_1);
 int r_ea_finetimer_isr();
 int * r_ea_sw_isr(void);
 unsigned int r_ea_offset_req(int param_1,ushort *param_2);
 unsigned int r_ea_sleep_check(uint *param_1,uint param_2); 
 uint r_ea_interval_duration_req(ushort *param_1,ushort *param_2); 
 undefined4 * r_ea_alarm_set(undefined4 *param_1);
 undefined4 r_ea_alarm_clear(int *param_1);
 undefined4 r_em_buf_init(void);
