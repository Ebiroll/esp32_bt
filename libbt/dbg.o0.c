...
typedef enum HCI_MSG {
    HCI_ACL_DATA_RX=2054,     //0x806
    HCI_ACL_DATA_TX=2055,     //0x807 
    HCI_CMD_CMP_EVENT=2049,   //0x801
    HCI_CMD_STAT_EVENT=2050,  //0x802
    HCI_COMMAND=2053,         //0x805         
    HCI_DBG_EVT=2057,         //0x809
    HCI_EVENT=2051,           //0x803
    HCI_LE_EVENT=2052,        //0x804
...
struct ke_msg_handler { // DWARF DIE: 2ca
    ke_msg_id_t id;
    undefined field_0x2;
    undefined field_0x3;
...
struct ke_state_handler { // DWARF DIE: 2f6
...
struct hci_basic_cmd_cmp_evt { // DWARF DIE: a8f
    uint8_t status;
};
